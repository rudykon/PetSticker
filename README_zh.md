...
这组公开安全案例展示了一张经过批准的宠物参考图，如何转化为形象统一、符合平台规格的完整专辑。输出保留了布鲁的大直立耳、暖灰棕短毛、轻巧匀称体型和鲜明表情，同时扩展出不同职场语境。
...
<p align="center"><sub>仅保留宠物主体，按 README 尺寸缩放，并移除原文件元数据。</sub></p>

<p align="center"><strong>↓ 角色圣经 → 素材规划 → 小批次生成 → 三层质量门禁 ↓</strong></p>
...
<p align="center"><sub>从完整 24 张专辑中选取的 8 张代表性透明表情。</sub></p>
